 ...
 */
export const APP_NAME = 'Flappy Degen';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION = 'Flappy Degen, tap to fly, dodge the pipes and earn degen tokens. ';
 ...
 */
export const APP_TAGS = ['game', 'arcade', 'skill-based', 'flappy', 'base', 'farcaster'];
 ...
 */
export const APP_BUTTON_TEXT = 'Let\'s Degen';
